function makeIsospectralMesh2(; lc=1e-2, outDir=".")
#
#  Uses Gmsh to generate a mesh of an isospectral domain 
#  (version 2 in Gordon, Webb, and Wolpert)
#  
  ...
  gmsh.model.geo.addPoint( 2.0, 0.0, 0.0, lc,  1)
  gmsh.model.geo.addPoint( 3.0, 0.0, 0.0, lc,  2)
  gmsh.model.geo.addPoint( 4.0, 1.0, 0.0, lc,  3)
  gmsh.model.geo.addPoint( 4.0, 3.0, 0.0, lc,  4)
  gmsh.model.geo.addPoint( 5.0, 3.0, 0.0, lc,  5)
  gmsh.model.geo.addPoint( 5.0, 4.0, 0.0, lc,  6)
  gmsh.model.geo.addPoint( 4.0, 4.0, 0.0, lc,  7)
  gmsh.model.geo.addPoint( 4.0, 6.0, 0.0, lc,  8)
  gmsh.model.geo.addPoint( 6.0, 6.0, 0.0, lc,  9)
  gmsh.model.geo.addPoint( 6.0, 5.0, 0.0, lc, 10)
  gmsh.model.geo.addPoint( 7.0, 5.0, 0.0, lc, 11)
  gmsh.model.geo.addPoint( 7.0, 6.0, 0.0, lc, 12)
  gmsh.model.geo.addPoint( 8.0, 6.0, 0.0, lc, 13)
  gmsh.model.geo.addPoint( 8.0, 7.0, 0.0, lc, 14)
  gmsh.model.geo.addPoint( 7.0, 7.0, 0.0, lc, 15)
  gmsh.model.geo.addPoint( 7.0, 8.0, 0.0, lc, 16)
  gmsh.model.geo.addPoint( 6.0, 8.0, 0.0, lc, 17)
  gmsh.model.geo.addPoint( 6.0, 7.0, 0.0, lc, 18)
  gmsh.model.geo.addPoint( 4.0, 7.0, 0.0, lc, 19)
  gmsh.model.geo.addPoint( 3.0, 6.0, 0.0, lc, 20)
  gmsh.model.geo.addPoint( 3.0, 4.0, 0.0, lc, 21)
  gmsh.model.geo.addPoint( 1.0, 4.0, 0.0, lc, 22)
  gmsh.model.geo.addPoint( 0.0, 3.0, 0.0, lc, 23)
  gmsh.model.geo.addPoint( 0.0, 2.0, 0.0, lc, 24)
  gmsh.model.geo.addPoint( 1.0, 2.0, 0.0, lc, 25)
  gmsh.model.geo.addPoint( 1.0, 3.0, 0.0, lc, 26)
  gmsh.model.geo.addPoint( 3.0, 3.0, 0.0, lc, 27)
  gmsh.model.geo.addPoint( 3.0, 1.0, 0.0, lc, 28)
  gmsh.model.geo.addPoint( 2.0, 1.0, 0.0, lc, 29)
