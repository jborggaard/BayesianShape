...
omega    = h5read(datafile,"omega");
rMin     = h5read(datafile,"rMin");
rMax     = h5read(datafile,"rMax");
a0       = h5read(datafile,"a0");
trueSamp = h5read(datafile,"sample");
obsMean  = h5read(datafile,"obs");
